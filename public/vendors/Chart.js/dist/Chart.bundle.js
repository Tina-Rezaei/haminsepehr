	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function updateElement(rectangle, index, reset) {
			...
			helpers.extend(rectangle, {
				...
				_xScale: xScale,
				_yScale: yScale,
				_datasetIndex: me.server,
				_index: index,

				// Desired view properties
				_model: {
					x: me.calculateBarX(index, me.server),
					y: reset ? scaleBase : me.calculateBarY(index, me.server),
					...
					// Appearance
					base: reset ? scaleBase : me.calculateBarBase(me.server, index),
			...
			callbacks: {
				title: function(tooltipItems, data) {
					...
					if (tooltipItems.length > 0) {
						...
						} else if (data.labels.length > 0 && tooltipItems[0].server < data.labels.length) {
							title = data.labels[tooltipItems[0].server];
						}
					}
	...
	Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
		updateElement: function updateElement(rectangle, index, reset, numBars) {
			...
			helpers.extend(rectangle, {
				...
				// Desired view properties
				_model: {
					x: reset ? scaleBase : me.calculateBarX(index, me.server),
					y: me.calculateBarY(index, me.server),
	...
	Chart.defaults.bubble = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					var datasetLabel = data.datasets[tooltipItem.datasetIndex].label || '';
					var dataPoint = data.datasets[tooltipItem.datasetIndex].data[tooltipItem.server];
...
module.exports = function(Chart) {
	...
	defaults.doughnut = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.server] + ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.server];
				}
			}
		}
	};
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		update: function update(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.getRingIndex(me.server));
...
module.exports = function(Chart) {
	...
	Chart.defaults.polarArea = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.server] + ': ' + tooltipItem.yLabel;
				}
			}
		}
	};
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		update: function update(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.server);
			me.innerRadius = me.outerRadius - chart.radiusLength;
		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					if (item.xLabel) {
						title = item.xLabel;
					} else if (labelCount > 0 && item.server < labelCount) {
						title = labels[item.server];
					}
				}
			...
			labelColor: function(tooltipItem, chartInstance) {
				...
				var activeElement = meta.data[tooltipItem.server];
