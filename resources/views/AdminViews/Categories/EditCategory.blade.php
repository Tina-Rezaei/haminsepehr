    ...
    <div class="col-md-12 col-sm-12 col-xs-12" >
        <div class="x_panel" >
            <div class="x_content" style="display: block;">
                <form id="form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate=""  enctype="multipart/form-data" method="post" action="{{route('categories.update',$category->id)}}">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input id="first-name" name="category_name" value="{{$category->name}}" class="form-control col-md-7 col-xs-12" type="text" style="margin-top:3px"  required>
                        </div>
                    </div>
                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
