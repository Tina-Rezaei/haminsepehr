<div class="col-md-3 left_col hidden-print">
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section active">
                ...
                <ul class="nav side-menu" style="">
                    <li class="active"><a><i class="fa fa-home"></i> پروژه <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: block;">
                            <li class="current-page"><a href="{{route('projects.index')}}">مشاهده پروژه ها</a></li>
                            <li><a href="{{route('projects.create')}}">افزودن پروژه</a></li>
                        </ul>
                    </li>
                    <li class="active"><a><i class="fa fa-home"></i>محصولات <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: block;">
                            <li class="current-page"><a  href="{{route('products.index')}}">مشاهده محصولات</a></li>
                            <li><a href="{{route('products.create')}}">افزودن محصول</a>
                            <li><a href="{{route('categories.index')}}">دسته بندی</a>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-edit"></i> کاربر <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{}}">اخبار</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-desktop"></i> عناصر ظاهری <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-windows"></i> افزودنیهای پیشنهاد شده <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa fa-sitemap"></i> منو چند سطحی <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="#level1_1">سطح یک</a>
                            </li><li><a>سطح یک<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                    ...
                    <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i> صفحه مقصد <span class="label label-success pull-left">به زودی</span></a></li>
                </ul>
            </div>
        ...
        <div class="sidebar-footer hidden-small">
            ...
            <a data-toggle="tooltip" data-placement="top" title="" onclick="toggleFullScreen();" data-original-title="تمام صفحه">
